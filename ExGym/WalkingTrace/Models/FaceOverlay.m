...
- (MAMapRect)getLeftMapRect
{
    MACoordinateRegion leftRegion = MACoordinateRegionMakeWithDistance(self.leftEyeCoordinate, self.leftEyeRadius * 2, self.leftEyeRadius * 2);
    return MAMapRectForCoordinateRegion(leftRegion);
}

- (MAMapRect)getRightMapRect
{
    MACoordinateRegion rightRegion = MACoordinateRegionMakeWithDistance(self.rightEyeCoordinate, self.rightEyeRadius * 2, self.rightEyeRadius * 2);
    return MAMapRectForCoordinateRegion(rightRegion);
}

- (MAMapPoint)getLeftCenter
{
    return MAMapPointForCoordinate(self.leftEyeCoordinate);
}

- (MAMapPoint)getRightCenter
{
    return MAMapPointForCoordinate(self.rightEyeCoordinate);
}
