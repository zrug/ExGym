...
- (MAOverlayView *)mapView:(MAMapView *)mapView viewForOverlay:(id <MAOverlay>)overlay
{
    if ([overlay isKindOfClass:[FaceOverlay class]])
    {
        ...
        overlayView.lineCap         = kCGLineCapButt;
        overlayView.lineDashPattern = [NSArray arrayWithObjects:[NSNumber numberWithFloat:30.0], [NSNumber numberWithFloat:10.0], nil];
