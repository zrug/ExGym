...
- (void)loginEvent:(id)sender {
    ...
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^(void) {
        ...
        MyPanelViewController *myPanelViewController = [[MyPanelViewController alloc] init];
        [self.navigationController pushViewController:myPanelViewController animated:NO];
    }];
